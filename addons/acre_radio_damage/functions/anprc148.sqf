["CAManBase", "HitPart", {
	...
	if (acre_radiodamage_prc148 == 0) exitWith {};
	_hasRadio = [_target, "ACRE_PRC148"] call acre_api_fnc_hasKindOfRadio;
